...
def generate_launch_description():
    ...
    world_launch_arg = DeclareLaunchArgument(
        ...
        choices=['simple_trees.sdf', 'large_world.sdf']
    )
    world_path = PathJoinSubstitution([
        FindPackageShare('robo1_haje'),
        'worlds',
    ...
    rgbd_depth_pcl2_bridge_node = Node(
        ...
        output='screen',
        arguments=['/model/drone/camera/points@sensor_msgs/msg/PointCloud2[ignition.msgs.PointCloudPacked'],
