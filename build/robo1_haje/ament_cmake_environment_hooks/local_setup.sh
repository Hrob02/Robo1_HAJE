...
: ${AMENT_CURRENT_PREFIX:="/home/eleanorlow/robo1/src/Robo1_HAJE/install/robo1_haje"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/robo1_haje/environment/pythonpath.sh"
